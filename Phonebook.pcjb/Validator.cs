...
class Validator
{
    ...
    public static string EmailPatternDescription { get; } = "Upper-/lowercase chars A-Z, digits 0-9, symbols '_.+-' and '@'";
    ...
    public static string PhoneNumberPatternDescription { get; } = "Digits 0-9, symbols '()+-', space, length 5 to 20 chars";
