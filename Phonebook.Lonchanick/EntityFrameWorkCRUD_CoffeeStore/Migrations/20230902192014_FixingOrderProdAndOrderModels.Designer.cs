...
namespace PlayingSpectre.Migrations
{
    ...
    [Migration("20230902192014_fixing-orderProd-and-Order-models")]
    partial class fixingorderProdandOrdermodels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayingSpectre.Models.Product", b =>
                {
                    b.Property<int>("CoffeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlayingSpectre.Models.OrderProd", b =>
                {
                    b.HasOne("PlayingSpectre.Models.Product", "Coffee")
                        .WithMany("OrderProd")
